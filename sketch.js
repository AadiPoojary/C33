...
function keyPressed(){
    if(keyCode === 32){
        //emptied the array so there is no smoke
        this.trajectory = [];
        slingshot.attach(bird.body);
        //changing the gameState to On Sling
        gameState = "On Sling";
        //directly teleported to the slingshot        
        Matter.Body.setPosition(bird.body,{x:190,y:40});
